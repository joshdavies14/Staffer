...
def allocate(request, swap, swap_id):
            ...
            for y in range(allocate_data[i][3]):
                ...
                for x in range(len(staff_data)):
                    ...
                    for a in range(len(pref_data2)):
                        ...
                        elif pref_data2[a][0] >= 2:
                            pref_array[a] = "AM"
                        elif pref_data2[a][1] >= 2:
                            pref_array[a] = "PM"
                    if len(pref_data2) > 0:
                        sft = pref_array[0]
                        ##print(pref_data2)
                ...
                ##add those who satisfy condition to new list
                ##print(allocate_data)
                ##print("i " , i)
                ##print("var " , allocate_data[i][3])
    ...
    if len(allocate_data) == 0:
        ...
        messages.success(request, "{} shifts allocated".format(total_allocated))
